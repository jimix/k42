 ...
 *
 * $Id: PSOSmallMeta.C,v 1.5 2004/09/15 20:48:36 dilma Exp $
 **************************************************************************/
 ...
 */
ServerObject *
PSOSmallMeta::clone(ObjTokenID otokID, FSFileKFS *f)
{
    ServerObject *pso = new PSOSmallMeta(otokID, f, llpso, globals);
    return pso;
}
