 ...
 *
 * $Id: BlockCacheLinux.C,v 1.1 2004/02/11 23:03:58 lbsoares Exp $
 **************************************************************************/
...
SysStatus
BlockCacheLinux::readBlock(uval32 pblkno, char *buffer, uval local)
{
    sval rc;
...
SysStatus
BlockCacheLinux::writeBlock(uval32 pblkno, char *buffer, uval local)
{
     sval rc;
